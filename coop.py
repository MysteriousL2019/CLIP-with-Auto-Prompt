...
if __name__ == '__main__':
    ...
    # 也就是cifar_test.py 中的text_features，而之后经过text_embeddings = model.text_projection的就是CLIP中的text_features = model.encode_text(text_inputs)
    # 所以init_hiddenstate == text_features == CLIP中的 text_inputs， 但我试过是1*77维度，如果是100class就是100，77
